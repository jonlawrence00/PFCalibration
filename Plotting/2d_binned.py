...
bin_range =[0,1.55,2.5,2.75,3]
print(bin_range)
print("Total bins : ", len(bin_range))
#Ebin_range = np.arange(0,204,4)
Ebin_range =[0, 2, 8, 12, 16, 20, 24, 28, 32, 36, 40, 44, 48, 52, 56, 60, 64, 68, 72, 76, 80, 84, 88, 92, 96, 100, 104, 114, 124, 134, 144, 154, 164, 174, 184, 194, 200, 204]
print(Ebin_range)
    ...
    for ibin in range(len(bin_range)-1):
        if(abs(eta_pkl[valid_idx[i]])>=bin_range[ibin] and abs(eta_pkl[valid_idx[i]]) <=bin_range[ibin+1]):
            for Ebin in range(len(Ebin_range)-1):
                if(abs(trueEn_pkl[valid_idx[i]])>=Ebin_range[Ebin] and abs(trueEn_pkl[valid_idx[i]]) <=Ebin_range[Ebin+1]):
...
for i in range(len(train_idx)):
    ...
    for ibin in range(len(bin_range)-1):
        if(abs(eta_pkl[train_idx[i]])>=bin_range[ibin] and abs(eta_pkl[train_idx[i]]) <=bin_range[ibin+1]):
            for Ebin in range(len(Ebin_range)-1):
                if(abs(trueEn_pkl[train_idx[i]])>=Ebin_range[Ebin] and abs(trueEn_pkl[train_idx[i]]) <=Ebin_range[Ebin+1]):
