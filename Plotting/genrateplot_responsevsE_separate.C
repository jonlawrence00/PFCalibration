...
void genrateplot_responsevsE_separate(TString legendname, TString plot_name, TString path2, TString plot_name2, TString region)
{
//=========Macro generated from canvas: Canvas_1_n2/Canvas_1_n2
  ...
  TH2F *respHisto__1 = (TH2F*) inputfile1_ -> Get("respHisto");
   ...
   respHisto__1->GetXaxis()->SetLabelOffset(0.009);
   respHisto__1->Draw("");
