...
#bin_range = np.arange(0,4,0.42)
#bin_range2 =[0.0001,0.42,0.84,1.26,1.68,2.1,2.52,2.94,3.36]
#print(bin_range2)
#print("Total bins : ", len(bin_range2))
...
#Ebin_range =[0, 2, 8, 12, 16, 20, 24, 28, 32, 36, 40, 44, 48, 52, 56, 60, 64, 68, 72, 76, 80, 84, 88, 92, 96, 100, 104, 114, 124, 134, 144, 154, 164, 174, 184, 194]
#Ebin_range2 =[2, 8, 16, 20, 24, 28, 32, 36, 40, 44, 48, 52, 56, 60, 64, 68, 72, 76, 80, 84, 88, 92, 96, 100, 104,108, 124, 134, 144, 154, 164, 174, 184, 194, 200]
...
hist2D_norm_Eta_predTrue_Train=ROOT.TProfile2D('hist2D_norm_Eta_predTrue_Train', """:"(pred-true)/true in GeV":""", 8, 0,3.36,10,0,400)
hist2D_norm_Eta_predTrue_Valid=ROOT.TProfile2D('hist2D_norm_Eta_predTrue_Valid', """:"(pred-true)/true in GeV":""", 8, 0,3.36,10,0,400)
